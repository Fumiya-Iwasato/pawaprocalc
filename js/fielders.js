...
$(function () {
  ...
  var getDefaultAbility = function getDefaultAbility() {
    ...
    $.getJSON(url, function (data) {
      ...
      $('.loader_wrap').addClass('hide'); //特能・クリック
  ...
  var calcMeet = function calcMeet(val) {
    ...
    if (val < 111) {
      var ability = ['', '', '', '', 'image/e.jpeg', 'image/d.jpeg', 'image/c.jpeg', 'image/b.jpeg', 'image/a.jpeg', 'image/s.jpeg', 'image/s1.jpeg', 'image/s1.jpeg'];
      $('#meetLevel').attr('src', ability[Math.floor(val / 10)]);
    } else {
      $('#meetLevel').attr('src', 'image/s2.jpeg');
    }
  ...
  var calcPower = function calcPower(val) {
    ...
    if (val < 111) {
      var ability = ['', '', '', '', 'image/e.jpeg', 'image/d.jpeg', 'image/c.jpeg', 'image/b.jpeg', 'image/a.jpeg', 'image/s.jpeg', 'image/s1.jpeg', 'image/s1.jpeg'];
      $('#powerLevel').attr('src', ability[Math.floor(val / 10)]);
    } else {
      $('#powerLevel').attr('src', 'image/s2.jpeg');
    }
  ...
  var calcRun = function calcRun(val) {
    ...
    if (val < 111) {
      var ability = ['', '', '', '', 'image/e.jpeg', 'image/d.jpeg', 'image/c.jpeg', 'image/b.jpeg', 'image/a.jpeg', 'image/s.jpeg', 'image/s1.jpeg', 'image/s1.jpeg'];
      $('#runLevel').attr('src', ability[Math.floor(val / 10)]);
    } else {
      $('#runLevel').attr('src', 'image/s2.jpeg');
    }
  ...
  var calcArm = function calcArm(val) {
    ...
    if (val < 111) {
      var ability = ['', '', '', '', 'image/e.jpeg', 'image/d.jpeg', 'image/c.jpeg', 'image/b.jpeg', 'image/a.jpeg', 'image/s.jpeg', 'image/s1.jpeg', 'image/s1.jpeg'];
      $('#armLevel').attr('src', ability[Math.floor(val / 10)]);
    } else {
      $('#armLevel').attr('src', 'image/s2.jpeg');
    }
  ...
  var calcDefense = function calcDefense(val) {
    ...
    if (val < 111) {
      var ability = ['', '', '', '', 'image/e.jpeg', 'image/d.jpeg', 'image/c.jpeg', 'image/b.jpeg', 'image/a.jpeg', 'image/s.jpeg', 'image/s1.jpeg', 'image/s1.jpeg'];
      $('#defenseLevel').attr('src', ability[Math.floor(val / 10)]);
    } else {
      $('#defenseLevel').attr('src', 'image/s2.jpeg');
    }
  ...
  var calcCatch = function calcCatch(val) {
    ...
    if (val < 111) {
      var ability = ['', '', '', '', 'image/e.jpeg', 'image/d.jpeg', 'image/c.jpeg', 'image/b.jpeg', 'image/a.jpeg', 'image/s.jpeg', 'image/s1.jpeg', 'image/s1.jpeg'];
      $('#catchLevel').attr('src', ability[Math.floor(val / 10)]);
    } else {
      $('#catchLevel').attr('src', 'image/s2.jpeg');
    }
